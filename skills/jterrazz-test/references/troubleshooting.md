...
Operative index. Each fix names the rule and the chapter whose **Pitfalls** section explains it. When a symptom isn't here, read the Pitfalls section of the matching chapter ([10](../../../docs/10-api.md)–[19](../../../docs/19-linting.md)).
