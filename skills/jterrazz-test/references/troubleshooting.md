...
| Uppercase test title rejected                                                      | Titles start lowercase (`vitest/prefer-lowercase-title`) — a prose fragment, not a sentence. The rulebook sets no `allowedPrefixes`: rename the title, or deviate in your own fragment. [19](../../../docs/19-linting.md) |
