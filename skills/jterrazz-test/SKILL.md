...
The full list, with ids to cite, is [references/rules.md](references/rules.md); the reasoning is the constitution, [docs/12](../../docs/18-conventions.md).
...
| -------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Writing **API** specs (HTTP, in-process)                             | [references/api.md](references/api.md)                         | [docs/10-api.md](../../docs/10-api.md)                                        |
| Writing **jobs** specs (background pipelines)                        | [references/jobs.md](references/jobs.md)                       | [docs/11-jobs.md](../../docs/11-jobs.md)                                      |
| Writing **CLI** specs (exec, env, fixtures, docker)                  | [references/cli.md](references/cli.md)                         | [docs/12-cli.md](../../docs/12-cli.md)                                        |
| Writing **spec documents** (`<case>.spec.yaml`)                      | [references/cli.md](references/cli.md)                         | [docs/12-cli.md](../../docs/12-cli.md)                                        |
| Writing **integration** specs (a module on real services / a golden) | [docs/06-integration.md](../../docs/06-integration.md)         | [docs/06-integration.md](../../docs/06-integration.md)                        |
| Writing **website** specs (fetch, visit, scenarios)                  | [references/website.md](references/website.md)                 | [docs/08-website.md](../../docs/08-website.md)                                |
| Writing **component** specs (render, hooks, DOM)                     | [references/component.md](references/component.md)             | [docs/07-component.md](../../docs/07-component.md)                            |
| Writing **mobile** specs (open, simulator, screens)                  | [references/mobile.md](references/mobile.md)                   | [docs/09-mobile.md](../../docs/09-mobile.md)                                  |
| **Dynamic values** / the `{{token}}` grammar                         | [references/tokens.md](references/tokens.md)                   | [docs/15-tokens.md](../../docs/15-tokens.md)                                  |
| **Declaring** what an LLM / HTTP call replies                        | [references/contracts.md](references/contracts.md)             | [docs/16-contracts.md](../../docs/16-contracts.md)                            |
| **Streamed** replies (`http.stream`, `http.sse`) and `intercept()`   | [references/contracts.md](references/contracts.md)             | [docs/16-contracts.md](../../docs/16-contracts.md)                            |
| **Time** (`clock`) and the **doubles ladder**                        | [docs/18-conventions.md](../../docs/18-conventions.md)         | [docs/18-conventions.md](../../docs/18-conventions.md)                        |
| **Services** and `process()`                                         | [docs/17-services.md](../../docs/17-services.md)               | [docs/17-services.md](../../docs/17-services.md)                              |
| Weird failures / **pitfalls**                                        | [references/troubleshooting.md](references/troubleshooting.md) | Pitfalls sections of each chapter                                             |
| **Rule ids** (lint plugin + checker)                                 | [references/rules.md](references/rules.md) (generated)         | [docs/12](../../docs/18-conventions.md) · [docs/13](../../docs/19-linting.md) |

Assertions in depth: [docs/14-assertions.md](../../docs/14-assertions.md). Services & infra: [docs/17-services.md](../../docs/17-services.md).
