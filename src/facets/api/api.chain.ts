/**
 * The api chain — the shared builder's, named here.
 *
 * Every facet folder carries the SAME four files (api.specification.ts,
 * api.chain.ts, api.result.ts, api.project.ts) so a reader who has seen one
