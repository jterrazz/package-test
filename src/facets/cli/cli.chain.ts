/**
 * The cli chain — the shared builder's, named here.
 *
 * Every facet folder carries the SAME four files (cli.specification.ts,
 * cli.chain.ts, cli.result.ts, cli.project.ts) so a reader who has seen one
