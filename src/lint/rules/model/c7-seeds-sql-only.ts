...
import { GROUND_SEEDS } from '../../../model/chain/ground.js';
...
export const c7SeedsSqlOnly: LintRule = {
    ...
    meta: {
        ...
        messages: {
            notSql: '_seeds/{{entry}} is not a .sql file — _seeds/ carries database state only; file state goes through .fixture().',
        },
        type: 'problem',
    },
};
