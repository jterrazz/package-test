...
import { findRoot } from '../../../model/chain/resolve.js';
...
/**
 * The root the convention would derive: the
...
export const a9wRedundantRoot: LintRule = {
    ...
    meta: {
        ...
        messages: {
            redundant:
                'root: "{{root}}" is redundant — walking up from the specification file already resolves to that directory.',
        },
        type: 'suggestion',
    },
};
