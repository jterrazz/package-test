...
export const c6ToMatchExtension: LintRule = {
    ...
    meta: {
        ...
        messages: {
            missingExtension:
                'toMatch("{{name}}") is missing its extension — the extension is part of the fixture name ("help.txt", never "help"); only directory-tree snapshots (_expected/<name>/) omit it.',
        },
        type: 'problem',
    },
};
