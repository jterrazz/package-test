...
export const SIBLINGLESS_KINDS: SiblinglessKind[] = [
    ...
    },
    {
        claims: oneOf(
            ...
            'src/core/ports/browser.port.ts',
            'src/core/ports/cli.port.ts',
            'src/core/ports/container.port.ts',
            'src/core/ports/database.port.ts',
            'src/core/ports/device.port.ts',
            'src/core/ports/isolation.port.ts',
            'src/core/ports/server.port.ts',
            'src/core/ports/service.port.ts',
    ...
    {
        claims: oneOf(
            'src/core/result/directory.ts',
            'src/core/result/filesystem.ts',
            'src/core/result/json.ts',
            'src/core/result/match-options.ts',
            'src/core/result/response.ts',
            'src/core/result/table.ts',
            'src/core/result/text.ts',
        ),
    ...
    {
        claims: oneOf(
            'src/core/chain/docker-reader.ts',
            'src/core/chain/ground.ts',
            'src/core/chain/registry.ts',
            'src/core/chain/services.ts',
            'src/core/contracts/stream.ts',
            'src/core/timing/pause.ts',
