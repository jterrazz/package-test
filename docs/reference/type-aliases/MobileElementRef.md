...
Defined in: [src/specification/ports/device.port.ts:25](https://github.com/jterrazz/package-test/blob/main/src/specification/ports/device.port.ts#L25)
...
(`tap`, `fill`) — see [MobileElementMatch](MobileElementMatch.md) and CONVENTIONS W3.
