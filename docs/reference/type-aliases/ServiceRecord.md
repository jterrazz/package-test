...
Defined in: [specification/facets/\_common/services.ts:12](https://github.com/jterrazz/package-test/blob/main/src/specification/facets/_common/services.ts#L12)
