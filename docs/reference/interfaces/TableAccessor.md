...
Defined in: [src/core/result/table.ts:15](https://github.com/jterrazz/package-test/blob/main/src/core/result/table.ts#L15)
...
Defined in: [src/core/result/table.ts:21](https://github.com/jterrazz/package-test/blob/main/src/core/result/table.ts#L21)
