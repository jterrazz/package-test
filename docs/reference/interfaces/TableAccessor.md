...
Defined in: [src/model/result/table.ts:15](https://github.com/jterrazz/package-test/blob/main/src/model/result/table.ts#L15)
...
Defined in: [src/model/result/table.ts:21](https://github.com/jterrazz/package-test/blob/main/src/model/result/table.ts#L21)
