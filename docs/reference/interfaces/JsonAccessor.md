...
Defined in: [src/model/result/json.ts:19](https://github.com/jterrazz/package-test/blob/main/src/model/result/json.ts#L19)
...
Defined in: [src/model/result/json.ts:48](https://github.com/jterrazz/package-test/blob/main/src/model/result/json.ts#L48)
