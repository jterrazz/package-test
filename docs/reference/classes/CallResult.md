...
Defined in: src/specification/facets/integration/result.ts:31
...
```ts
new CallResult(options): CallResult;
```

Defined in: src/specification/facets/integration/result.ts:34
...
Defined in: src/specification/facets/integration/result.ts:46
...
```ts
get value(): TextAccessor | JsonAccessor;
```

Defined in: src/specification/facets/integration/result.ts:60
...
[`TextAccessor`](TextAccessor.md) \| [`JsonAccessor`](JsonAccessor.md)
