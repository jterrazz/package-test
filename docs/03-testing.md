...
| `src/lint/checker-member.test.ts`           | the member pass — what a workspace member owes                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 15    |
...
| `src/lint/package-exports.test.ts`          | package-exports — F1 reads the published contract · package-exports — the root has two runtimes and one type surface                                                                                                                                                                                                                                                                                                                                                                                 | 6     |
